...
**Tidy up imports**
 ...
 IDE refactorization should rename at once the classes and the imports. Search in your IDE for "Moma" and replace by *"coolem"*

- coolem/protocols/protocol_hello_world.py:
 class MomaPrefixHelloWorld --> class CoolemPrefixHelloWorld

- coolem/protocol/__init__.py:
 from .protocol_hello_world import MomaPrefixHelloWorld --> from .protocol_hello_world import CoolemPrefixHelloWorld

- coolem/wizards/wizard_hello_world.py:
 _targets = [(MomaPrefixHelloWorld, ['message'])]  -->     _targets = [(CoolemPrefixHelloWorld, ['message'])]
 class MomaPrefixHelloWorldWizard --> class CoolemPrefixHelloWorldWizard

- coolem/wizards/__init__.py:
 from .wizard_hello_world import MomaPrefixHelloWorldWizard  --> from .wizard_hello_world import CoolemPrefixHelloWorldWizard

- protocols.conf: rename MomaPrefixHelloWorld --> CoolemPrefixHelloWorld
